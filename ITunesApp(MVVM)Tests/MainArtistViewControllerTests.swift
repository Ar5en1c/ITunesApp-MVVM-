...
//        
//        viewModel = MockArtistDataViewModel(apiClass: <#ApiClass#>)
...
//            ArtistInfo(artistName: "Test Artist", country: "US", primaryGenreName: "Pop", collectionPrice: 9.99, artworkUrl60: "url", trackName: "MOCKTRACK")
//        ])
//        
//        viewController.loadData(searchTerm: "a")
//        
...
//        let mockData = [
//            ArtistInfo(artistName: "Test Artist1", country: "US", primaryGenreName: "Pop", collectionPrice: 9.99, artworkUrl60: "url", trackName: "MOCKTRACK"),
//            ArtistInfo(artistName: "Test Artist2", country: "US", primaryGenreName: "Pop2", collectionPrice: 9.99, artworkUrl60: "url2", trackName: "MOCKTRACK")
//        ]
//        
